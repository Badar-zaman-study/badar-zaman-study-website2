...
// Compound pagination primitives for admin-style pagination2
export function PaginationContainer({
  ...
  return (
    <nav className={cn('flex items-center justify-end', className)} {...props}>
      {children}
    </nav>
  );
}
...
export function PaginationItem({
  ...
  return (
    <li className={cn('inline-flex', className)} {...props}>
      {children}
    </li>
  );
}
...
export function PaginationLink({
  ...
  return (
    <a
      className={cn(
        'inline-flex h-8 w-8 items-center justify-center rounded-md border border-gray-200 bg-white text-sm font-medium text-gray-700 transition hover:border-gray-300 hover:text-black',
        isActive && (activeClassName ?? 'bg-primary text-primary-foreground border-primary'),
        className
      )}
      {...props}
    >
...
export function PaginationPrevious({
  ...
  return (
    <a
      className={cn(
        'inline-flex h-8 min-w-[36px] items-center justify-center rounded-md border border-gray-200 bg-white px-2 text-sm font-medium text-gray-700 transition hover:border-gray-300 hover:text-black',
        className
      )}
      {...props}
    >
...
export function PaginationEllipsis({
  ...
  return (
    <span
      className={cn(
        'inline-flex h-8 w-8 items-center justify-center rounded-md text-sm text-gray-500',
        className
      )}
      {...props}
    >
...
// Alias for compound pagination wrapper
